            ...
            <div class="card shadow-sm mt-4" style="border: none; border-radius: 12px; background: var(--bg-dark); border: 1px solid var(--glass-border);">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo BASE_URL; ?>/admin/forceUnlock" method="POST" class="form-inline">
                        <input type="number" name="table_no" class="form-control mr-3" placeholder="Table No. (1-20)" min="1" max="20" required style="width: 180px; background-color: var(--bg-light); color: var(--text-light); border: 1px solid var(--glass-border);">
